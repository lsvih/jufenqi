...
<group title="身份信息">
  ...
  <x-input title="身份证" type="number" placeholder="请输入正确的身份证号码" keyboard="number"></x-input>
  <x-input title="手机" class="weui_vcode" name="mobile" placeholder="请输入手机号码" keyboard="number" is-type="china-mobile">
    <x-button slot="right" mini plain style="color:#3ba794;border:none;">获取验证码</x-button>
  </x-input>

  <x-input title="验证码" placeholder="请输入您收到的验证码"></x-input>
</group>
